...
pylab.plot(np.load('elements.npy'), fluidity_pyop2_seq_speedup, 'y-d', lw=2, label='Fluidity-PyOP2 sequential (1 core)')
pylab.plot(np.load('elements.npy'), fluidity_pyop2_openmp_speedup, 'c-v', lw=2, label='Fluidity-PyOP2 OpenMP (12 threads)')
pylab.plot(np.load('elements.npy'), fluidity_pyop2_mpi_speedup, 'r-<', lw=2, label='Fluidity-PyOP2 MPI (12 cores)')
pylab.plot(np.load('elements.npy'), fluidity_pyop2_cuda_speedup, 'm-^', lw=2, label='Fluidity-PyOP2 CUDA (1 GPU)')
