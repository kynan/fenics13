...
pylab.plot(np.load('elements.npy'), np.load('fluidity_mpi.npy'), 'k-o', lw=2, label='Fluidity (cores: 48)')
pylab.plot(np.load('elements.npy'), np.load('fluidity_pyop2_mpi.npy'), 'g-s', lw=2, label='Fluidity-PyOP2 (backend: mpi)')
